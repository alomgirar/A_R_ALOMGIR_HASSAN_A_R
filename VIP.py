...
logo=("""\033[1;97m
     ______   __         ______   __       __   ______   ______  _______        
 /      \ /  |       /      \ /  \     /  | /      \ /      |/       \       
/$$$$$$  |$$ |      /$$$$$$  |$$  \   /$$ |/$$$$$$  |$$$$$$/ $$$$$$$  |      
$$ |__$$ |$$ |      $$ |  $$ |$$$  \ /$$$ |$$ | _$$/   $$ |  $$ |__$$ |      
$$    $$ |$$ |      $$ |  $$ |$$$$  /$$$$ |$$ |/    |  $$ |  $$    $$<       
...
$$/   $$/ $$$$$$$$/  $$$$$$/  $$/      $$/  $$$$$$/  $$$$$$/ $$/   $$/ 
\33[1;37m----------------------------------------------
→   Owner      :  ALOMGIR_HASSAN
→   Facebook   :  ALOMGIR_HASSAN
→   Github     :  alomgirar
...
def menu():
			...
			if rifat in ['1','01']:
				...
				os.system('xdg-open https://www.facebook.com/profile.php?id=100086576736749 ');menu()
			elif rifat in ['8','08']:
				exit('')
			else:
